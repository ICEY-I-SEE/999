...
//   name: "ReissueCard",
    ...
    methods: {
        ...
        addNumber(){
            ...
            // this.level==0? leve =1 : leve =this.level
        ...
        saveInfo(){
            ...
            this.$router.push({
                path: '/Pay/PayWay?level_id=' + this.levelInfo.id+'&card_num='+this.card_num+'&isReissue=1'+'&cardType='+this.cardType,
            })
        }
    },
    filters: {
...
<style lang="stylus" scoped>
    ...
    .reissue-card-wrap /deep/ .res-card-header .f-title-wrap
        padding-top 6px
    .content
        color #fff
        font-size 30px
