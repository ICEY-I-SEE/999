            ...
            <div class="order-area">
                <div class="user-msg">
                    ...
                    <p class="user-id">
                        ...
                        <!-- <span>邀请码：{{personalData.code}}</span> -->
                    </p>
                </div>
                <div class="member-msg">
                    <div class="name">
                        <img src="/static/images/user/level-5.png" alt="">
                        <div class="level level-0" v-if="personalData.level === 0">普通用户</div>
                        <div class="level level-1 nolineHeight" v-if="personalData.level === 1">VIP会员</div>
                        <div class="level level-2 nolineHeight" v-if="personalData.level === 2">官方经理</div>
                        <div class="level level-3 nolineHeight" v-if="personalData.level === 3">高级经理</div>
                        <div class="level level-4 nolineHeight" v-if="personalData.level === 4">大区经理</div>
                        <div class="level level-5 nolineHeight" v-if="personalData.level === 5">执行合伙人</div>
                        <div class="level level-5 nolineHeight" v-if="personalData.level == '-1'">会员体验卡</div>
                    </div>
                    <!-- <div class="date" v-if="personalData.level==1 || personalData.level === 5">{{personalData.vip_time | formatDate}} 到期</div> -->
                    <div class="date" v-if="personalData.level >0 || personalData.level == '-1'"><span>会员卡{{personalData.vip_time | formatDate}}到期</span></div>
                </div>
                <!-- <div class="date" v-if="personalData.level >0">会员{{personalData.vip_time | formatDate}}到期</div> -->
                <div class="headline">
                    <h3>我的订单</h3>
        ...
        methods: {
            ...
            musharing(){
                if(Number(this.personalData.level) !== 0 || this.personalData.level=='-1'){
                    ...
                    this.isTc = true
                    this.tcText = '成为会员或经理人，即可拥有自己的专属二维码~'
                }
            },
            reqUser() {
