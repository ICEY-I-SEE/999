<template>
    <div class="container">
		  <div class="jumpTo" @click="jumpToDetails(orderId)">
        ...
        <div class="lucky-wheel">
            <div class="wheel-main">
                ...
                <div class="prize-btn">
                    <img @click="toCashCoupon()" class="prize-btn-img" src="/static/images/luckywheel/go_btn.png"/>
                </div>
            </div>
        </div>
      ...
      <div class="toast-container">
				...
				<div class="title">
            获得<span class="count">{{this.results.number}}</span>张<span class="count">{{this.results.name}}</span>元代金券
          </div>
        ...
        <div class="toast-mask" v-show="toast_control" @click="close_toast"></div>
    </div>
</template>
<script>
export default {
    ...
    toCashCoupon(){
        this.$router.push('/user/CashCoupon')
    },
		//此方法为处理奖品数据
...
.jumpTo{
	width: 50px;
	height: 50px;
	background: url("../../../static/images/public/left_arrow.png") no-repeat;
...
.prize-btn{
  ...
  height:297px;
  margin:63px auto 0;
  background:url('/static/images/luckywheel/go_bg.png');
...
.toast-container {
  ...
  height:377px;
	/* height: 800px; */
  background: url("/static/images/luckywheel/rult_bg.png") no-repeat;
  background-size:100%;
	position: relative;
}
